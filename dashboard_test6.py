...
# =========================
# Numeric Feature Analysis Module (Enhanced)
# =========================
...
plot_type = st.radio("Select Plot Type:", ['Scatter Plot', 'Box Plot'])
...
if selected_numeric:
    if plot_type == 'Scatter Plot':
        ...
        fig_num = px.scatter(df, x=selected_numeric, y='readmitted_numeric',
                             color='readmitted',
                             trendline="ols",
                             title=f"Scatter Plot of {selected_numeric} vs Readmission with Trendline",
                             labels={'readmitted':'Readmission Status', selected_numeric:selected_numeric})
        st.plotly_chart(fig_num, use_container_width=True)

    elif plot_type == 'Box Plot':
        # Box plot with mean marker
        fig_num = px.box(df, x='readmitted', y=selected_numeric,
                         color='readmitted',
        ...
        for i, row in means.iterrows():
            fig_num.add_scatter(x=[row['readmitted']], y=[row[selected_numeric]],
